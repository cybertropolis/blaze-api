...
from sources.utilities.dataset import dataset_utilities
...
class DatasetDescriptor:
    ...
    def get_split(self, split_name, dataset_dir, file_pattern=None, reader=None):
        ...
        if LOAD_READABLE_NAMES:
            if dataset_utilities.has_labels(dataset_dir):
                labels_to_names = dataset_utilities.read_label_file(
                    dataset_dir)
            else:
                labels_to_names = self.create_readable_names_for_imagenet_labels()
                dataset_utilities.write_label_file(
                    labels_to_names, dataset_dir)
